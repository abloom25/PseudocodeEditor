...
import { ArrowLeft, BarChart3, Bug, Cookie, Database, ShieldCheck } from 'lucide-react';
...
export function PrivacyPageContent() {
  ...
  return (
    <main className="h-screen overflow-y-auto bg-[#050914] px-4 py-6 text-[#DCE7FF] sm:px-6 lg:px-8">
